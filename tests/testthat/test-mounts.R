...
test_that("Remap nas in Paddington", {
  ...
  shares <- Map(path_mapping,
                ...
                c("O:", "P:", "K:"))
  expect_equal(shares$other$path_remote, "\\\\fi--didef3.dide.ic.ac.uk\\other")
  expect_equal(shares$project$path_remote, "\\\\fi--didenas1.dide.ic.ac.uk\\Project")
  expect_equal(shares$sk$path_remote, "\\\\wpia-hn.hpc.dide.ic.ac.uk\\newshare")
