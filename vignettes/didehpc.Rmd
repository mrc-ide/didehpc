...
```
## [ init:id   ]  8e8a73f0697ba7e3bb299da27a8ff5ba
```
...
```
## [ save:id   ]  5e6121c412492f70cf81bf66a6061182
```
...
```
## Loading context 5e6121c412492f70cf81bf66a6061182
```

```
## [ context   ]  5e6121c412492f70cf81bf66a6061182
```
...
##     templates: list
##     unsubmit: function (t)
##     workdir: /home/rich/net/home/cluster_testing/20170306/vignette
...
##  fi--didemrc13    1   23    24    96%
##  fi--didemrc14   23    1    24     4%
##  fi--didemrc15    0   24    24   100%
##  fi--didemrc16    0   24    24   100%
...
##  fi--didemrc24    4    8    12    67%
##  fi--didemrc25    0   12    12   100%
##  fi--didemrc26    0   12    12   100%
##  fi--didemrc27    0   12    12   100%
##  fi--didemrc28    0   12    12   100%
##  fi--didemrc38    0   16    16   100%
##  fi--didemrc39   15    1    16     6%
##  fi--didemrc40    0   16    16   100%
##  fi--didemrc41    0   16    16   100%
##  fi--didemrc42    0   16    16   100%
##  fi--didemrc43    0   16    16   100%
##  fi--didemrc44   16    0    16     0%
##  fi--didemrc45   14    2    16    12%
##  fi--didemrc46   16    0    16     0%
##  fi--didemrc47    0   16    16   100%
##  fi--didemrc48   14    2    16    12%
##  fi--didemrc49   16    0    16     0%
##  fi--didemrc50   16    0    16     0%
##  fi--didemrc51    0   20    20   100%
##  fi--didemrc52   20    0    20     0%
##  fi--didemrc53    0   20    20   100%
##  fi--didemrc54   12    8    20    40%
##  fi--didemrc55   20    0    20     0%
##  fi--didemrc56    0   20    20   100%
##  fi--didemrc57   20    0    20     0%
##  fi--didemrc58   12    8    20    40%
##  fi--didemrc59   20    0    20     0%
##  fi--didemrc60   20    0    20     0%
##  fi--didemrc61   20    0    20     0%
##  fi--didemrc62   20    0    20     0%
##  fi--didemrc63    0   20    20   100%
##  fi--didemrc64    0   20    20   100%
##  fi--didemrc65    0   32    32   100%
##  fi--didemrc66   16   16    32    50%
##  fi--didemrc67   24    0    24     0%
##  fi--didemrc68    0   24    24   100%
##  fi--didemrc69   24    0    24     0%
##  fi--didemrc70    0   24    24   100%
##  fi--didemrc71   16    8    24    33%
##  fi--didemrc72    0   24    24   100%
##  fi--didemrc73   24    0    24     0%
##  fi--didemrc74    0   24    24   100%
##  fi--didemrc75    0   16    16   100%
##  fi--didemrc76   14    2    16    12%
##  fi--didemrc77    0   16    16   100%
##  fi--didemrc78   28    0    28     0%
## -------------- ---- ---- ----- ------
## fi--didemrchnb  445  699  1144    61%
```
...
##  [5] digest_0.6.12    grid_3.3.2       context_0.1.0    R6_2.2.0
...
##     id: 28f6d34ae79f6915b092adc8c1ea5413
...
## 1 28f6d34ae79f6915b092adc8c1ea5413 2017-03-06 17:28:58    <NA>     <NA>
...
```
## Error: task 28f6d34ae79f6915b092adc8c1ea5413 is unfetchable: PENDING
```
...
## [ context   ]  5e6121c412492f70cf81bf66a6061182
## [ task      ]  28f6d34ae79f6915b092adc8c1ea5413
## [ expr      ]  make_tree(10)
## [ start     ]  2017-03-06 17:28:59.589
##     I am building a tree!
## [ ok        ]
## [ end       ]  2017-03-06 17:28:59.682
```
...
```
## [1] "28f6d34ae79f6915b092adc8c1ea5413" "703372da1650125198623f941be88ae9"
```
...
```
## [1] "28f6d34ae79f6915b092adc8c1ea5413"
```
...
```
## a3fd7be6e08f9793fe1abd04a027027e e6bb1eb5f4494b772fe7d44ebc77556f
##                       "COMPLETE"                       "COMPLETE"
## 733fe69bf1a40ba81ccf1b8dc87f7834 f7967e130e23a110292c7869fc852c7b
##                       "COMPLETE"                       "COMPLETE"
## a570d404eaa4ccfd00f65f6264be5baf 33ec811df041d1baee768f1468d038e1
##                       "COMPLETE"                        "PENDING"
```
...
```
## [1] "Syntax: HPCJobCancel scheduler user id1,id2,id3,id4...\nOutput: (TSV) ID Status\n                (Status = {OK,NOT_FOUND,WRONG_USER,WRONG_STATE,ID_ERROR})\n"
```
...
```
## Error: task 5fe327414f69156fd93f904b14326892 is unfetchable: RUNNING
```
...
```
## [1] "Syntax: HPCJobCancel scheduler user id1,id2,id3,id4...\nOutput: (TSV) ID Status\n                (Status = {OK,NOT_FOUND,WRONG_USER,WRONG_STATE,ID_ERROR})\n"
## [2] "Syntax: HPCJobCancel scheduler user id1,id2,id3,id4...\nOutput: (TSV) ID Status\n                (Status = {OK,NOT_FOUND,WRONG_USER,WRONG_STATE,ID_ERROR})\n"
## [3] "Syntax: HPCJobCancel scheduler user id1,id2,id3,id4...\nOutput: (TSV) ID Status\n                (Status = {OK,NOT_FOUND,WRONG_USER,WRONG_STATE,ID_ERROR})\n"
## [4] "Syntax: HPCJobCancel scheduler user id1,id2,id3,id4...\nOutput: (TSV) ID Status\n                (Status = {OK,NOT_FOUND,WRONG_USER,WRONG_STATE,ID_ERROR})\n"
```
